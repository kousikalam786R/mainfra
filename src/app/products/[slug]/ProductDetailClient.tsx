...
export default function ProductDetailClient() {
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "#F8FAFC" }}>
      {/* Header ÔÇö matches Gallery / Products */}
      <Box
        sx={{
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <Image
                      ...
                      alt={`${product.name} ÔÇö image ${activeImage + 1}`}
                      fill
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            >
              ...
              >
                ...
                <Typography variant="body2" sx={{ color: "text.secondary" }}>
                  Range: {product.priceRange} ┬À Custom sizes available
                </Typography>
              </Paper>
              ...
              >
                ...
                <Box>
                  ...
                  <Typography variant="caption" sx={{ color: "text.secondary" }}>
                    Pan-India delivery from Ranchi ┬À Installation support available
                  </Typography>
                </Box>
              </Paper>
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid size={{ xs: 12, md: 5 }}>
                    ...
                    >
                      ...
                      >
                        {company.salesManagerTitle} ┬À {company.shortName}
                      </Typography>
                      <Box
                        sx={{
                          display: "flex",
